...
int main(int argc, const char * argv[]) {
    ...
    // 2. Diabetes: Now the above treatment also applies to the diabetes cases. However, because the glucose level for the diabetes
    //      subject usually does not return the normal value after a long time period,  the treatment is actually not effective.
